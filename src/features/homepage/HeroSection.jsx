      ...
      <div className="app-container flex w-screen flex-col justify-between gap-10 md:flex-row">
        <div className="flex w-full flex-col sm:items-center sm:justify-center lg:items-start lg:justify-start">
          <div>
            <h1
              id="animate"
              className="max-w-[560px] text-[2.3rem] font-medium leading-[40px] text-[#000] md:text-[3.3rem] md:leading-[70px] lg:text-[3.75rem]"
            >
              Navigating the digital landscape for success
            </h1>
            <div className="flex items-center justify-center lg:hidden">
              <img src="/images/hero-img.png" className="w-full" />
            </div>
          </div>
        ...
        <div className="hidden lg:block">
          <img src="/images/hero-img.png" className="max-w-[500px]" />
        </div>
      </div>
    </section>
  );
